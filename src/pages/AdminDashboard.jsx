    ...
    <div style={{ minHeight: '100vh', padding: '2rem' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
        ...
        <div className="glass-panel" style={{ padding: '2rem' }}>
          ...
          <ul style={{ listStyle: 'none' }}>
            <li style={{ padding: '10px 0', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
              <strong>New Space Listing</strong> - Miami Beach Front
              <div style={{ display: 'flex', gap: '10px', marginTop: '10px' }}>
                <button className="btn-primary" style={{ padding: '5px 10px', fontSize: '0.8rem' }}>Approve</button>
                <button className="btn-secondary" style={{ padding: '5px 10px', fontSize: '0.8rem' }}>Reject</button>
              </div>
            </li>
            <li style={{ padding: '10px 0', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
              <strong>Seller Application</strong> - Global Spaces Inc.
              <div style={{ display: 'flex', gap: '10px', marginTop: '10px' }}>
                <button className="btn-primary" style={{ padding: '5px 10px', fontSize: '0.8rem' }}>Approve</button>
                <button className="btn-secondary" style={{ padding: '5px 10px', fontSize: '0.8rem' }}>Reject</button>
              </div>
        ...
        <div className="glass-panel" style={{ padding: '2rem' }}>
          ...
          <button className="btn-secondary" style={{ width: '100%', marginBottom: '1rem' }}>Manage Users</button>
          <button className="btn-secondary" style={{ width: '100%', marginBottom: '1rem' }}>Platform Settings</button>
          <button className="btn-secondary" style={{ width: '100%' }}>View Support Tickets (4)</button>
        </div>
